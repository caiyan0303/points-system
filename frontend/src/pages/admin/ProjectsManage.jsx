...
import {
  ...
  FolderKanban, ChevronRight, Users, TrendingUp,
} from 'lucide-react'
...
export default function AdminProjects() {
  ...
  const handleCreate = async () => {
    try {
      ...
      showToast('项目创建成功')
      setShowCreate(false)
      setCreateForm({ name: '', year_name: '', description: '' })
      fetchProjects()
    } catch (err) {
                ...
                <div key={project.id} className="bg-white rounded-xl border border-gray-200 p-6 hover:border-indigo-200 transition-colors">
                  ...
                  <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                    <button onClick={() => {
                      ...
                      setEditForm({ name: project.name, description: project.description || '', year_id: project.year_id })
